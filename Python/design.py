...
"}")
        ...
        self.lbl_temp.setStyleSheet(u"font-size: 18px;\n"
"color: #888;")
        ...
        self.le_entry.setStyleSheet(u"font-size: 40px;\n"
"border: none;")
        ...
        self.gridLayout.addWidget(self.btn_div, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_calc, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_neg, 0, 3, 1, 1)
...
#endif // QT_CONFIG(shortcut)
        self.btn_calc.setText(QCoreApplication.translate("MainWindow", u"C", None))
#if QT_CONFIG(shortcut)
